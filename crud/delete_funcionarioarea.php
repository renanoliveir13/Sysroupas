	...
	<?php
		...
		if(isset($_POST['Deletar'])){
			...
			if ($tipo_cargo == "Gerente") {
				...
				header('Location: /web/form_crud/form_delete_funcionarioarea.php?id='.$cd_funcionario.'&error='.$msg);
				exit;
			}
			...
			try {
				...
				if (($_SESSION['cargo_usuario'] == "Gerente") || ($_SESSION['cargo_usuario'] == "Administrador")) {
					header('Location: /web/form_crud/form_area_adm.php/#nome');
					die;
		...
		// Caso nao exista
			...
			echo '<p><a href="../form_crud/form_delete_funcionarioarea.php/#exc_func" 

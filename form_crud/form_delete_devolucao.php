...
if (empty($_GET['id'])) {
    header('Location: /web/form_crud/form_select_devolucao.php');
}
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Excluir devolução (Atalho = Alt + w)</h4>
										<h5 class="text mt-2">Deseja excluir este registro?</h4>

                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="/web/crud/delete_devolucao.php">

                                            <div class="row">
                                                <div class="col-md-4 pr-1">
                                                    <div class="form-group">
                                                    <label>ID Devolução *</label>
													
													<input type="number" readonly name="cd_devolucao" value="<?= $_GET['id']; ?>" class="form-control" accesskey="w" title="Campo para mostrar o registro de devolução">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <?php } ?>
                                            <a type="submit" class="btn btn-danger pull-left" href="/web/form_crud/form_select_devolucao.php">Voltar</a>

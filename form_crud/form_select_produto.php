										...
										if (!empty($linhas))
											foreach ($linhas as $exibir_colunas) {
												...
												<div class="dropdown-menu">													
													<a class="dropdown-item " style="border-radius: 20px;" <a href="/web/form_crud/form_update_produto.php?id=' . $exibir_colunas['cd_produto'] . '">Atualizar</a>
													<a class="dropdown-item" style="border-radius: 20px;" <a href="/web/form_crud/form_insert_produtoentrada.php?id=' . $exibir_colunas['cd_produto'] . '">Entrada</a>
													<a class="dropdown-item" style="border-radius: 20px;" <a href="/web/form_crud/form_select_produtohistorico.php?id=' . $exibir_colunas['cd_produto'] . '">Histórico</a>
													<a class="dropdown-item"  style="border-radius: 20px;"href="/web/form_crud/form_delete_produto.php?id=' . $exibir_colunas['cd_produto'] . '" >Excluir</a>
													</div>
												</td>';
												echo '</tr>';
												echo '</p>';

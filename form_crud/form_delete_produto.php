...
try {
	...
	$query = $conexao->prepare("SELECT nome FROM compra_produto WHERE cd_produto = :id");
						...
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-header">
									<h4 class="card-title">Excluir produto (Atalho = Alt + w)</h4>
									<h5 class="text mt-2">Deseja excluir este registro?</h4>
								</div>
								<div class="card-body">
									<form method="POST" action="/web/crud/delete_produto.php">

										<div class="row">
											<div class="col-md-12 pr-1">
												<div class="form-group">
													<label>ID Produto *</label>
													<input type="text" name="nome" value="<?= $dados['nome']; ?>" class="form-control" readonly accesskey="w" title="Campo que mostra o registro do produto">
													<input type="hidden" name="cd_produto" value="<?= $_GET['id']; ?>" class="form-control">
												</div>
											</div>
										</div>
										...
										<?php } ?>
										<a type="submit" class="btn btn-danger pull-left" href="/web/form_crud/form_select_produto.php">Voltar</a>

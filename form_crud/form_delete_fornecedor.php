...
try {
    ...
    $query = $conexao->prepare("SELECT nome FROM fornecedor WHERE cd_fornecedor = :id");
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Excluir fornecedor (Atalho = Alt + w)</h4>
                                        <h5 class="text mt-2">Deseja excluir este registro?</h4>

                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="/web/crud/delete_fornecedor.php">

                                            <div class="row">
                                                <div class="col-md-4 pr-1">
                                                    <div class="form-group">
                                                    <label>ID Fornecedor *</label>
													<input type="text" name="nome" value="<?= $dados['nome']; ?>" class="form-control" readonly accesskey="w" title="Campo que mostra o registro de dono">
													<input type="hidden" name="cd_fornecedor" value="<?= $_GET['id']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <?php } ?>
                                            <a type="submit" class="btn btn-danger pull-left" href="/web/form_crud/form_select_fornecedor.php">Voltar</a>

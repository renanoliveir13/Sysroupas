...
try {
	...
	$selecao = "SELECT venda.cd_venda, compra_produto.nome AS nome_produto, 
	funcionario.nome AS nome_funcionario, cliente.nome AS nome_cliente, 
	venda.tipo_pagamento, produtos_venda.valor_item, produtos_venda.quantidade, compra_produto.quantidade AS estoque,
	produtos_venda.valor_venda, venda.data_venda FROM produtos_venda

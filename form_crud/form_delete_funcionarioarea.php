...
if (empty($_GET['id'])) {
	header('Location: /web/form_crud/form_area_adm.php');
}
...
<head>
	...
	<title>Excluir funcionário (Área administrador)</title>
					...
					<div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
									<form method="POST" action="/web/crud/delete_funcionarioarea.php">

										<div class="row">
											<div class="col-md-12 pr-1">
												<div class="form-group">
													<label>ID Funcionário *</label>
													<input type="text" name="nome" value="<?= $dados['nome']; ?>" class="form-control" readonly title="Campo que mostra o registro do funcionário" accesskey="w">
										...
										<?php } ?>
										<a type="submit" class="btn btn-danger pull-left" href="/web/form_crud/form_area_adm.php">Voltar</a>

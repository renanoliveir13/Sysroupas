						...
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-header">
									<h4 class="card-title">Excluir venda (Atalho = Alt + w)</h4>
									<h5 class="text mt-2">Deseja excluir este registro?</h5>
									<h5 class="text mt-2">A venda será excluida, assim como os itens registrados.</h5>
								</div>
								<div class="card-body">
									<form method="POST" action="/web/crud/delete_venda.php">

										<div class="row">
											<div class="col-md-12 pr-1">
												<div class="form-group">
													<label>ID Venda *</label>													
													<input type="number" readonly name="cd_venda" value="<?= $_GET['id']; ?>" class="form-control" accesskey="w" title="Campo que mostra o registro da venda">
												</div>
											</div>
										</div>
										...
										<?php } ?>
										<a type="submit" class="btn btn-danger pull-left" href="/web/form_crud/form_select_venda.php">Voltar</a>

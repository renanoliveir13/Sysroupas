...
<?php
	...
	INNER JOIN produtos_devolucao ON (produtos_devolucao.cd_devolucao = produtos_devolucao.cd_devolucao)
	...
	try {
		...
		$registros_devolucao = "SELECT devolucao.cd_devolucao,venda.cd_venda, compra_produto.nome,
		compra_produto.marca, compra_produto.codigo_barra, compra_produto.cor, compra_produto.tamanho, 
		compra_produto.genero, produtos_venda.valor_item,
		produtos_devolucao.quantidade, produtos_venda.quantidade AS qtd_vendida, compra_produto.quantidade AS estoque, 
		produtos_devolucao.valor_devolucao, produtos_devolucao.motivo_devolucao, devolucao.data_devolucao,
		venda.tipo_pagamento, funcionario.nome AS nome_funcionario, cliente.nome AS nome_cliente, cliente.cpf AS cpf_cliente

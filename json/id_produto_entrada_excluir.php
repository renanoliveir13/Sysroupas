<?php
	...
	// Variavel $cd_entrada que recebe a coluna cd_entrada da tabela produto_entrada
	$cd_produto_entrada = $_POST["cd_produto_entrada"];  // Importante ser $_GET para a requisicao funcionar
	...
	try {
		...
		$procurar_produto = "SELECT * FROM produtos_entrada WHERE cd_produto_entrada = :cd_produto_entrada";
		$busca_registro = $conexao->prepare($procurar_produto);
		$busca_registro->bindValue(':cd_produto_entrada', $cd_produto_entrada);
		...
		$selecao = "DELETE FROM produtos_entrada WHERE cd_produto_entrada = :cd_produto_entrada";
		// $seleciona_dados recebe $conexao que prepare a operacao para selecionar
		$seleciona_dados = $conexao->prepare($selecao);
		// Vincula um valor a um paramentro
		$seleciona_dados->bindValue(':cd_produto_entrada', $cd_produto_entrada, PDO::PARAM_INT);
		// Executa a operacao
